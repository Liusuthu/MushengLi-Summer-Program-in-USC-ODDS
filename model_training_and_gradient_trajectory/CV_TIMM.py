...
def main(args):
    ...
    transformation_mnist = torchvision.transforms.Compose([
        torchvision.transforms.Resize((224,224)),#https://discuss.pytorch.org/t/runtimeerror-stack-expects-each-tensor-to-be-equal-size-but-got-3-224-224-at-entry-0-and-3-224-336-at-entry-3/87211/10
        torchvision.transforms.ToTensor(),
    ...
    if args.dataset_name in ['SVHN','CIFAR10','MNIST']:
        num_classes=10
    ...
    if args.dataset_name in ['SVHN','Food101','GTSRB','FGVCAircraft']:
        ...
        trainset = getattr(torchvision.datasets,args.dataset_name)(root='data/', train=True, download=True, transform=transformation_mnist)
        testset = getattr(torchvision.datasets,args.dataset_name)(root='data/', train=False, download=True, transform=transformation_mnist)
