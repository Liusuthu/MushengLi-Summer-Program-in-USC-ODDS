...
if __name__ == '__main__':
    ...
    try:
        ...
        print("x:",args.x,",xmin:",args.xmin,",xmax:",args.xmax,",xnum:",args.xnum)
        print("y:",args.y,",ymin:",args.ymin,",ymax:",args.ymax,",ynum:",args.ynum)
    except:
    ...
    #--------------------------------------------------------------------------
    net = model_loader.my_load(args.dataset, args.model, args.model_file)
    ...
    # Setup dataloader
    #--------------------------------------------------------------------------
    # download CIFAR100 if it does not exit
